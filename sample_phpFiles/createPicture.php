...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $profileID = filter_var($obj->profileID, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);    //Get the submitted username
    $activityID = filter_var($obj->activityID, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);    //Get the submitted passcode
    $imgData = filter_var($obj->imgData, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);  
