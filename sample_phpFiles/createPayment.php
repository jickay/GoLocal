...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $payment_type = filter_var($obj->type, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);  
    ...
    $sql = "INSERT INTO payment (account_num, amount, type, username)
            VALUES (:account_num, :amount, :type, :username);";
...
//     // Just need to change these to get correct values
//     $account_num = filter_var($obj->payment->account_num, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);
//     $username = filter_var($obj->payment->username, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW); 
//     $amount = filter_var($obj->payment->amount, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW); 
//     $payment_type = filter_var($obj->payment->payment_type, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);  
